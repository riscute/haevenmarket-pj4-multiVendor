...
<mt:template_store title="User">
	<jsp:attribute name="content">
        ...
        <div class="container-fluid">
        	<!-- Form product biding -->
        	<s:form id="basic-form" modelAttribute="product" action="${pageContext.request.contextPath}/store/product/edit" method="post" enctype="multipart/form-data">
        		 <div class="row clearfix">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="body">                              
                                ...
                                <a href="${pageContext.request.contextPath}/store/product/index" class="btn btn-default">Cancel</a>
