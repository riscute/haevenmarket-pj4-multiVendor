...
<mt:template_store title="User">
	<jsp:attribute name="content">
        ...
        <div class="container-fluid">
        	<!-- Form product biding -->
        	<s:form id="basic-form" modelAttribute="product" action="${pageContext.request.contextPath}/store/product/new" method="post" enctype="multipart/form-data">
        		 <div class="row clearfix">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3 ">        
                                        <div class="custom-file">
                                            <input type="file" name="files"  multiple id="inputGroupFile01" accept="image/gif, image/jpg, image/jpeg, image/png">
<!--                                             <label class="custom-file-label border border-info" for="inputGroupFile01">Choose Image</label> class="custom-file-input"-->
                                        </div>
                                    </div>
                                    <small style="color:red" class="form-group">${msgfile }</small> 
                                    <div class="mb-3 row ">
                                        <div class="col-lg-2 col-md-6 col-sm-12 m-b-30"><a href="assets/images/image-gallery/1.jpg"><img class="img-fluid img-thumbnail" src="assets/images/image-gallery/1.jpg" alt=""></a></div>
                                        <div class="col-lg-2 col-md-6 col-sm-12 m-b-30"><a href="assets/images/image-gallery/2.jpg" ><img class="img-fluid img-thumbnail" src="assets/images/image-gallery/2.jpg" alt=""></a></div>
                                        <div class="col-lg-2 col-md-6 col-sm-12 m-b-30"><a href="assets/images/image-gallery/3.jpg" ><img class="img-fluid img-thumbnail" src="assets/images/image-gallery/3.jpg" alt=""></a></div>
                                        <div class="col-lg-2 col-md-6 col-sm-12 m-b-30"><a href="assets/images/image-gallery/4.jpg" ><img class="img-fluid img-thumbnail" src="assets/images/image-gallery/4.jpg" alt=""></a></div>
                                        <div class="col-lg-2 col-md-6 col-sm-12 m-b-30"><a href="assets/images/image-gallery/5.jpg" ><img class="img-fluid img-thumbnail" src="assets/images/image-gallery/5.jpg" alt=""></a></div>
                                        <div class="col-lg-2 col-md-6 col-sm-12 m-b-30"><a href="assets/images/image-gallery/6.jpg" ><img class="img-fluid img-thumbnail" src="assets/images/image-gallery/6.jpg" alt=""></a></div>  
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <small style="color:red" class="form-group">${msgcategory }</small> 
                                </div>
                            </div>
                        </div>
                    </div>
