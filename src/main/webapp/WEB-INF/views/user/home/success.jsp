...
<mt:template_home title="Contact">
    ...
    <div class="super_card_email">
      ...
      <div style="border-radius:200px; height:200px; width:200px; background: #F8FAF5; margin:0 auto;">
        <i id="iconcheck" class="fa fa-check-circle-o" style="font-size: 150px"></i>
      </div>
        <div>
        <h3 class="titleemail" > <b>SUCCESS</b> </h3> 
        <p class="txtp">We have received your message.<br/> We will be in touch shortly!</p>
      </div>
      <br>
