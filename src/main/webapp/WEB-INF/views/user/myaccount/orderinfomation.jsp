							...
							<c:forEach items="${order.orderDetails }" var="orderDetail">				
								<tr>
									<td class="text-center">
										<a href="${pageContext.request.contextPath}/user/product/${orderDetail.product.productId}"><img width="85" class="img-thumbnail" title="Aspire Ultrabook Laptop" alt="Aspire Ultrabook Laptop" src="${pageContext.request.contextPath}/assets/uploads/products/${orderDetail.product.images[0].name}">
										</a>
									</td>
