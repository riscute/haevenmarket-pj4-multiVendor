...
public interface OrdersRepository extends CrudRepository<Orders, Integer>{
	...
	@Query(value ="from Orders where status.statusId =:statusId and user.username =:username order by orderId desc")
	public List<Orders> findAllByStatusAndUsername(@Param("statusId") int statusId,@Param("username") String username);
	...
	public List<Orders> findAllByStoreIdAndStatusId2(@Param("userId") int userId,@Param("statusId") int statusId);
