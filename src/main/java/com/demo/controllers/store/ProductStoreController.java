...
public class ProductStoreController {
	...
	public String create(@ModelAttribute("product") Product product  ,@RequestParam("categoryId") int categoryId ,
...
//				storeService.save(store);
	...
	public String edit(@ModelAttribute("product") Product product  ,@RequestParam("categoryId") int categoryId ,
